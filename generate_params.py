...
def all_params_to_files(input_folder, output_folder):
    all_params = generate_all_parameters(output_folder)
    all_params_to_csv("params.csv", input_folder)
