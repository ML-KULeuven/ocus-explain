...
from pyexplain.solvers.params import COusSubsetParams, DisjointMCSes, Grow


class OCUSExplainSubsets(OCUSExplain):
    def __init__(self, C: CNF, params: COusSubsetParams, verbose=True, matching_table=None):
        assert isinstance(params, COusSubsetParams), f"Expected {COusSubsetParams} got {type(params)}"
    ...
    def __del__(self):
        ...
        """
        if self.hittingset_solver is not None:
