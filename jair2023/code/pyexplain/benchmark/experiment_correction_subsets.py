...
from generate_params import all_params_to_sbatch_files, exec_time_correction_subsets
...
base_fname_all_configs = "logic_corr_subsset_"

all_params = exec_time_correction_subsets(
    output_folder=CORRECTION_SUBSETS_HPC_OUTPUT_FOLDER,
    selected_puzzles='logic'
)
...
base_fname_all_configs = "sudoku_corr_subsset_"

all_params = exec_time_correction_subsets(
    output_folder=CORRECTION_SUBSETS_HPC_OUTPUT_FOLDER,
    selected_puzzles='sudoku'
)
